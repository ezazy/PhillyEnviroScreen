...
PhillyEnviroScreen_map <- tm_shape(PhillyEnviroScreen_index) + tm_polygons("index", style = 'quantile', pal = "plasma", title = "PhillyEnviroScreen\nIndex", border.col = "white") +
...
tmap_arrange(PhillyEnviroScreen_map, holcD_map)
